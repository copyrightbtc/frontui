...
class AddressComponent extends React.Component<Props, State> {
    ...
    private uploadFileSizeGuide = () => {
        if (authsforUploadSizeMinRange) {
            return this.translate('page.body.kyc.address.uploadFile.sizeMinMax', authsforUploadSizeMaxRange.toString(), authsforUploadSizeMinRange.toString());
        }

        return this.translate('page.body.kyc.address.uploadFile.sizeMax', authsforUploadSizeMaxRange.toString());
    };
