...
class DocumentsComponent extends React.Component<Props, DocumentsState> {
            ...
            <React.Fragment>
                <div className="documents-verifying"> 
                    <div className="documents-verifying__title">
                        <h6>{this.translate('page.body.kyc.documents.select.idcard.title')}</h6>
                    ...
                    <div className="documents-verifying__column">
                        <div className="row">
                            <fieldset className={idNumberFocusedClass}>
                                <label className="relate">{this.translate('page.body.kyc.documents.idNumber')}</label>
                                <CustomInput
                                    type="string"
                    ...
                    <h6>{this.translate('page.body.kyc.documents.select.upload.idcard')}</h6>
                        ...
                        <div className="documents-verifying__main-wrapper__left">
                            <div className="upload-file__wrapper">
                                <div className="upload-file__title">
                                    {this.translate('page.body.kyc.documents.uploadFile.front.id.title')}
                                </div>
                                <UploadFile
                            ...
                            <div className="upload-file__wrapper">
                                <div className="upload-file__title">
                                    {this.translate('page.body.kyc.documents.uploadFile.back.id.title')}
                                </div>                               
                                <UploadFile
                                    isMobileDevice={isMobileDevice}
                                    id="fileBack" 
                            ...
                            <div className="upload-file__wrapper">
                                <div className="upload-file__title">
                                    {this.translate('page.body.kyc.documents.uploadFile.selfie.id.title')}
                                </div>  
                                <UploadFile
                                    isMobileDevice={isMobileDevice}
                                    id="fileSelfie" 
    ...
    private createFormData = (docCategory: string, upload: File[], identificator: string) => {
        ...
        request.append('doc_type', 'Identity card');
...
export const IdentityCardIndex = compose(
    injectIntl,
    withRouter,
