...
class Head extends React.Component<Props> {
    ...
    private renderMarketToggler = () => {
        const { currentMarket, marketSelectOpened } = this.props;

        return (
            <div className={`markets-select${marketSelectOpened ? ' active' : ''}`} onClick={this.props.toggleMarketSelector}>
...
const mapStateToProps = (state: RootState): ReduxProps => ({
    ...
    marketSelectOpened: selectMarketSelectorState(state),
