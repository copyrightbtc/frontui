...
const MercuryoComponent = props => {
    ...
    return (
        <form className="ewallets-modal" action="https://www.sfor.trade/merchant/mercuryo/index.php" method="post"> 
            <div className="ewallets-modal__header">
                <img src={mercuryo} alt="Mercuryo Logo" draggable="false"/>
                <span>{formatMessage({id: 'deposit.with.ewallets.going.mercuryo' })}</span>
...
const MercuryoPayment = React.memo(MercuryoComponent);
