...
const PayeerpaymentComponent = props => {
    ...
    return (
        <form className="ewallets-modal" action="https://www.sfor.trade/merchant/payeer/index.php" method="post"> 
            <div className="ewallets-modal__header">
                <img src={payeer} alt="Payeer Logo" draggable="false"/>
                <span>{formatMessage({id: 'deposit.with.ewallets.going.payeer' })}</span>
...
const Payeerpayment = React.memo(PayeerpaymentComponent);
