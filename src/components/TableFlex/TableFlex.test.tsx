...
describe('Table render', () => {
    ...
    it('should set selected row in props', () => {
        ...
        const result = renderedComponent.find('.flexi-table__row--selected').first().children().first().html();
        ...
        // const nextResult = component.find('.flexi-table__row--selected').first().children().first().html();
    ...
    it('uses table styles by default', () => {
        ...
        expect(wrapper.find('table.flexi-table')).toBeDefined();
    });

    it('render thead styles by default', () => {
        const wrapper = setup({ header, data }).render();
        expect(wrapper.find('thead.flexi-table__head')).toBeDefined();
    });

    it('render tbody styles by default', () => {
        const wrapper = setup({ data }).render();
        expect(wrapper.find('tbody.flexi-table__body')).toBeDefined();
    });
    ...
    it.skip('should filter data according to clicked filter', () => {
        ...
        const filterButton = wrapper.find('.flexi-table__filter').at(1);
    ...
    it.skip('should render selected row', () => {
        ...
        expect(selectedRow.hasClass('flexi-table__row--selected')).toBeTruthy();
    });
    ...
    it('should render the same length of background rows as data', () => {
        ...
        const backgroundRows = wrapper.find('.flexi-table-background__row');
