...
describe('Decimal', () => {
    ...
    it('should have className for number after dot', () => {
        const wrapper = setup();
        expect(wrapper.find('span').last().hasClass('decimal-opacity')).toBeTruthy();
    });
    ...
    it('should rounding child and afterDot - non-highlighted', () => {
        ...
        expect(spans.first().hasClass('decimal-opacity')).toBeFalsy();
        expect(spans.first().props().children).toEqual('123');
        // second span - rounded and non-highlighted
        expect(spans.last().hasClass('decimal-opacity')).toBeTruthy();
    ...
    it('should handle prevValue prop', () => {
        ...
        expect(spans.first().hasClass('decimal-opacity')).toBeTruthy();
        expect(spans.first().props().children).toEqual('12');
        // second span - highlighted
        expect(spans.last().hasClass('decimal-opacity')).toBeFalsy();
