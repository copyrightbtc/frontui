...
const WalletWithdrawBodyComponent = props => {
    ...
    const withdrawAmountLabel = intl.formatMessage({ id: 'page.body.wallets.tabs.withdraw.content.amount' });
    ...
    const withdrawAllButtonLabel = intl.formatMessage({ id: 'page.body.wallets.tabs.withdraw.content.button.all' });
