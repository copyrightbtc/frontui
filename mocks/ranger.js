...
class RangerMock {
    ...
    initConnection(ws, request) {
        ...
        ws.timers.push(setInterval(tickersMock(ws, this.markets), 3001));
        ws.timers.push(setInterval(balancesMock(ws), 3001));
        ws.timers.push(setInterval(p2pOrdersMock(ws, 'approved'), 3001));
        ws.timers.push(setInterval(p2pOrdersMock(ws, 'cancelled'), 30010));
        ws.timers.push(setInterval(p2pOffersMock(ws, 'cancelled'), 30010));
        ws.timers.push(setInterval(p2pOffersMock(ws, 'created'), 30010));
        ws.timers.push(setInterval(p2pOffersMock(ws, 'updated'), 30010)); 
        ws.timers.push(setInterval(p2pPublicOffersMock(ws, 'cancelled'), 30010));
        ws.timers.push(setInterval(p2pPublicOffersMock(ws, 'created'), 30010));
        ws.timers.push(setInterval(p2pPublicOffersMock(ws, 'updated'), 30010));    
        ...
        ws.timers.push(setTimeout(() => {sendEvent(ws, "deposit_address", { address: "0x00eec1e95026faf0412d7a29b94d514d31446141", currencies:["ltc"], blockchain_key:"erc20", type:"create" })}, 3001));
